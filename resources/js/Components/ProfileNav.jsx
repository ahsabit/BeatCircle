...
export default function ProfileNav () {
    ...
    return (
        <>
            ...
            <div ref={accountOptWrapper} className="fixed z-50 top-14 right-14 rounded-lg overflow-hidden bg-[#3f3f3f] w-64 max-w-1/2 hidden">
